...
<link href="css/style.css" rel="stylesheet" type="text/css" />
    <script>
        function getCode() {
            ...
            img.src = "userSvl?method=validateCode&a="+new Date();
        }
    </script>
</head>
<body>
...
<div class="usBox clearfix">
	<div class="usBox_1 f_l">
		...
		<form name="formLogin" action="userSvl?method=login" method="post">
			<table width="100%" border="0" align="left" cellpadding="3" cellspacing="5">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <img id="validateImg" src="userSvl?method=validateCode" width="90" height="20" style="position:relative;top: 7px;">
